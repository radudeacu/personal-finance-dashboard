      ...
      <div className="flex items-center gap-10 2xl:gap-20">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:block">
            <p className="text-lg font-medium text-black dark:text-gray-400">Radu Deacu</p>
            <span className="text-sm text-gray-700 dark:text-gray-500">deacuradu@gmail.com</span>
          </div>
